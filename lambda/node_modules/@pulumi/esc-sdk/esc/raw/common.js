...
exports.createRequestFunction = exports.toPathString = exports.serializeDataIfNeeded = exports.setSearchParams = exports.setOAuthToObject = exports.setBearerAuthToObject = exports.setApiKeyToObject = exports.assertParamExists = exports.DUMMY_BASE_URL = void 0;
    ...
    return __awaiter(this, void 0, void 0, function* () {
        if (configuration && configuration.accessToken) { // override to access token because that is more correct for Pulumi auth
            let localVarApiKeyValue = typeof configuration.accessToken === 'function'
                ? yield configuration.accessToken(keyParamName)
